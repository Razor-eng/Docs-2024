...
import { ClientSideSuspense, useMutation, useStorage } from "@liveblocks/react/suspense";
...
const Marker = ({ isDragging, isLeft, onDoubleClick, onMouseDown, position }: Props) => {
    return (
        <div
